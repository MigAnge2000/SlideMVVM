...
using SlimeMVVM.Contracts;
using SlimeMVVM.Events;
using SlimeMVVM.Exceptions;
        ...
        private static IPopupPlatform PopupPlatform
        {
            get
            {
                ...
                if (!popupPlatform.IsInitialized)
                    throw new RGInitialisationException(Config.InitializationDescriptionUrl);
